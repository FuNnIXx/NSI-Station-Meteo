...
def get_wind_img():
    ...
    if wind_deg == '---':
        # return '0'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/0.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/0.png')))
    elif wind_deg >= 337 or wind_deg < 22:
        # return 'n'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/n.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/n.png')))
    elif 22 <= wind_deg < 67:
        # return 'ne'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/ne.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/ne.png')))
    elif 67 <= wind_deg < 112:
        # return "e"
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/e.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/e.png')))
    elif 112 <= wind_deg < 157:
        # return 'se'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/se.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/se.png')))
    elif 157 <= wind_deg < 202:
        # return 's'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/s.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/s.png')))
    elif 202 <= wind_deg < 247:
        # return 'sw'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/sw.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/sw.png')))
    elif 247 <= wind_deg < 292:
        # return "w"
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/w.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/w.png')))
    else:
        # return 'nw'
        wind_display_img.configure(light_image=Image.open(resource_path(f'img/icons_wind/nw.png')), dark_image=Image.open(
            resource_path(f'img/icons_wind/nw.png')))
...
def call_api():
    ...
    try:
        ...
        messagebox.showerror('Error', "Erreur de l'API Météo. Réponse invalide.")
        return
...
def refresh_ui():
    ...
    visibility_display_img.configure(light_image=Image.open(resource_path(f'img/icons_vis/{get_visibility_img()}.png')), dark_image=Image.open(resource_path(f'img/icons_vis/{get_visibility_img()}.png')))
    vis_value.configure(text=visibility)
    cloud_display_img.configure(light_image=Image.open(resource_path(f'img/icons_clouds/{get_clouds_img()}.png')), dark_image=Image.open(resource_path(f'img/icons_clouds/{get_clouds_img()}.png')))
    cloud_value.configure(text=cloud)
    humidity_display_img.configure(light_image=Image.open(resource_path(f'img/icons_hum/{get_humidity_img()}.png')), dark_image=Image.open(resource_path(f'img/icons_hum/{get_humidity_img()}.png')))
...
def city_search_get():
    ...
    if search_term:
        ...
        payload = {"country" : f"{ctr_name}"}
        try:
            response = requests.post(url, json=payload)
            response.raise_for_status()  # Raise an exception for bad status codes
            cities_data = response.json()
        except requests.exceptions.RequestException as e:
            messagebox.showerror('Error', f"Erreur de l'API Villes: {e}")
            return
        except requests.exceptions.JSONDecodeError:
            messagebox.showerror('Error', "Erreur de l'API Villes. Réponse invalide.")
            return

        if cities_data.get('error'):
            messagebox.showerror('Error', f"API Villes: {cities_data.get('msg', 'Erreur inconnue')}")
            return

        cities = cities_data.get('data', [])
...
conditions_display_img = CTkImage(light_image=Image.open(resource_path(f'img/icons/{condition_img}@2x.png')), dark_image=Image.open(resource_path(f'img/icons/{condition_img}@2x.png')), size=(190, 190))
...
visibility_display_img = CTkImage(light_image=Image.open(resource_path('img/icons_vis/00.png')), dark_image=Image.open(
    resource_path('img/icons_vis/00.png')), size=(165, 165))
...
cloud_display_img = CTkImage(light_image=Image.open(resource_path('img/icons_clouds/0.png')), dark_image=Image.open(
    resource_path('img/icons_clouds/0.png')), size=(165, 165))
...
humidity_display_img = CTkImage(light_image=Image.open(resource_path('img/icons_hum/00.png')), dark_image=Image.open(
    resource_path('img/icons_hum/00.png')), size=(165, 165))
